...
public class DubboConsumerAutoConfiguration {
    public static final Map<GenericClassIdBean, Object> DUBBO_REFERENCES_MAP = new ConcurrentHashMap<>();
    ...
    private <T> ReferenceBean<T> getConsumerBean(Class<T> interfaceClazz, DubboConsumer dubboConsumer)
        ...
        // 泛化调用
        consumerBean.setGeneric(dubboConsumer.generic());
        return consumerBean;
    }
}
